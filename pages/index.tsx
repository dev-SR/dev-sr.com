...
export default function Home() {
  return (
    <div className={styles.container}>
      <Head>
        <title>Sharukh Rahman | Software Engineer & Technology Specialist</title>
        <meta name="description" content="I&#x27;m a technology lead based in Jakarta, Indonesia specializing in crafting (and occasionally designing) exceptional, highly-effective websites and applications."/>
        <meta name="author" content="Sharukh Rahman"/>
        <meta name="twitter:card" content="summary"/>
        <meta name="twitter:creator" content="@hello_SRs"/>
